...
public class SinglePowerDeltaApplianceState implements ApplianceState {

	private PowerDeltaStateTransition transition;
	
	public SinglePowerDeltaApplianceState(PowerDeltaStateTransition transition) {
		this.transition = transition;
	}
	
	@Override
	public int getCurrentPower() {
		return (int)transition.getVariableValues()[0];
	}
	...
	public void createPowerShutoff() {
		transition = new PowerDeltaStateTransition(-1, transition.getUserAppliance(), -2, true, transition.getTime(), -1 * getCurrentPower(), (int)transition.getVariableValues()[1], 1);
	}
