...
public interface MachineLearningEngine {
	...
	public enum MODEL_TYPE {YATSI, SIMPLE};
	public enum ATTRIBUTE_TYPE {NUMERIC,NOMINAL};
	...
	public int predictWithModel(int modelId, double[] variableValues, double minProbability);
	
	public int loadModel(Serializable result);
