...
public class GenericStateTransition extends ApplianceStateTransition {

	public GenericStateTransition(int id, UserAppliance userAppliance, int detectionAlgorithmId, boolean on, long time) {
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof GenericStateTransition)) return false;
		return super.equals(obj);
	}
	
	// hashcode method is same as super
