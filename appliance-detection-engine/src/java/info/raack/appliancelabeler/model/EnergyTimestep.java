...
public class EnergyTimestep {
	...
	public EnergyTimestep copyWithoutEnergyOrAppliance() {
		EnergyTimestep ts = new EnergyTimestep();
		ts.startTime = (Date) startTime.clone();
		ts.endTime = (Date) endTime.clone();
		ts.energyConsumed = 0;
		return ts;
	}
}
