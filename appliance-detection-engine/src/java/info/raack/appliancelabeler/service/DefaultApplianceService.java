...
public class DefaultApplianceService implements ApplianceService {
	...
	private UserApplianceRowMapper userApplianceRowMapper = new UserApplianceRowMapper();
	...
	public List<UserAppliance> getUserAppliancesForUserId(String userId) {
		return jdbcTemplate.query("select * from user_appliances where user_id = ?", new Object[] {userId}, userApplianceRowMapper);
	}
	
	private class UserApplianceRowMapper implements RowMapper<UserAppliance> {
		public UserAppliance mapRow(ResultSet rs, int num) throws SQLException {
