...
public class OAuthAutomaticAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		// any OAuthAutomaticAuthenticationTokens which pass through here are automatically authenticated

		return authentication;
	}

	public boolean supports(Class<? extends Object> authentication) {
		return (OAuthAutomaticAuthenticationToken.class.isAssignableFrom(authentication));
	}
