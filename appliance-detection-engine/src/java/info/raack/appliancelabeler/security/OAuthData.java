...
public class OAuthData {
	...
	private OAuthRequestProcessor requestProcessor;
	private OAuthSecurityContext securityContext;
	
	public OAuthData(OAuthRequestProcessor oAuthRequestProcessor, OAuthSecurityContext oAuthContext) {
		this.requestProcessor = oAuthRequestProcessor;
		this.securityContext = oAuthContext;
	}

	public OAuthRequestProcessor getRequestProcessor() {
		return requestProcessor;
	}

	public OAuthSecurityContext getSecurityContext() {
