...
public class ApplianceTest {
	...
	@Test public void idGetterSetterWorks() {
		appliance.setId(1234);
		assertEquals(1234, appliance.getId());
	}
	
	@Test public void descriptionGetterSetterWorks() {
		appliance.setDescription("test");
		assertEquals("test", appliance.getDescription());
	}
	
	@Test public void equalsWorks() {
		Appliance other = new Appliance();
		appliance.setId(1234);
		appliance.setDescription("test");
		other.setId(1234);
		other.setDescription("test");
		
		assertEquals(other,appliance);
	}
	
	@Test public void notEquals() {
		Appliance other = new Appliance();
		assertFalse(other.equals(appliance));
	}
}
