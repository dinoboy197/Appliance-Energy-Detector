...
public class ModelStorageTest {
	...
	@Test public void modelGetterSetterWorks() {
		CollectiveRandomizableSingleClassifierEnhancer model = mock(CollectiveRandomizableSingleClassifierEnhancer.class);
		storage.setModel(model);
		assertEquals(model, storage.getModel());
	}
	
	@Test public void trainingDataGetterSetterWorks() {
		Instances instances = mock(Instances.class);
		storage.setTrainingData(instances);
		assertEquals(instances, storage.getTrainingData());
	}
}
