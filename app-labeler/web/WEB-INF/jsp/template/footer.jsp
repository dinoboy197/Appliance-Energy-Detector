...
#-------------------------------------------------------------------------------%>
<%-- put JS in footer, even if it is ugly and does not validate... 
http://developer.yahoo.com/performance/rules.html#js_bottom --%>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js"></script>
<script type="text/javascript" src="http://cdn.jquerytools.org/1.2.5/all/jquery.tools.min.js"></script>
<!--<script type="text/javascript" src="/highstock-1.0b/js/highstock.src.js"></script>
<script type="text/javascript" src="/highstock-1.0b/js/modules/exporting.js"></script> -->
