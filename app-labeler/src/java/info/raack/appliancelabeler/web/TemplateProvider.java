...
public class TemplateProvider {
	...
	@Autowired
	protected StepgreenUserDetails userDetails;

	public ModelAndView showPageInTemplate(int templateNumber, String view, ModelMap model) {
		// show the requested page with the view and model specified
		model.put("_fragment_", view);
			 
    	model.put("googleAnalyticsAccount", googleAnalyticsAccount);
    	model.put("userDetails", userDetails);
    	model.put("allUserIds", database.getAllUserIds());
		return new ModelAndView("template/template" + templateNumber, model);
	}
