...
public class SimulatedStateTransition extends GenericStateTransition {

	public SimulatedStateTransition(int id, UserAppliance userAppliance, int detectionAlgorithmId, boolean on, long time) {
		super(id, userAppliance, detectionAlgorithmId, on, time);
	}
	
	@Override
	public String toString() {
		return "(Simulated) " + super.toString();
	}
