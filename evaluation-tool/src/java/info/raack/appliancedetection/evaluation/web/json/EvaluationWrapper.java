 ...
 ******************************************************************************/
package info.raack.appliancedetection.evaluation.web.json;
...
public class EvaluationWrapper extends Evaluation {
	...
	public EvaluationWrapper(Evaluation evaluation) {
		...
		this.simulation = evaluation.getSimulation();
		this.predictedEnergyUsage = evaluation.getPredictedEnergyUsage();
		this.overallEnergyError = evaluation.getOverallEnergyError();
		this.overallAccuracy = evaluation.getOverallAccuracy();
		this.stateTransitionAccuracy = evaluation.getStateTransitionAccuracy();
		this.stateTransitionRecall = evaluation.getStateTransitionRecall();
		this.stateTransitionPrecision = evaluation.getStateTransitionPrecision();
		this.applianceEnergyErrors = evaluation.getApplianceEnergyErrors();
		this.predictedApplianceStateTransitions = evaluation.getPredictedApplianceStateTransitions();
	...
	private void loadSecondData() {
		...
		for(SecondData point : simulation.getSecondData()) {
