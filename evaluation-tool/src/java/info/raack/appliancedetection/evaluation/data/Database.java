...
public interface Database {
	...
	public Simulation getSimulation(String simulationId, Date start, Date end, boolean includeRawPowerMeasurements);

	public SimulationGroup getSimulationGroup(int simulationGroupId);
	public void saveSimulationGroup(SimulationGroup group);

	public boolean isSimulationDone(String simulationId);

	public void setDone(Simulation simulation);
	
	public EnergyMonitor getSimulatedEnergyMonitor(String simulationId);
